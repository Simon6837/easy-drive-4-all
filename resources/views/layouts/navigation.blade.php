<header class="bg-gray-800" x-data="{ isOpen: false }">
    <nav class="container px-6 mx-auto md:flex md:justify-between md:items-center">
        <div class="flex items-center justify-between">
            <a href="/"><img class="spin w-20 h-20 fill-current" src="{{URL('assets/logo-wit.svg')}}"></a>
        ...
        <div :class="isOpen ? 'flex' : 'hidden'" class="flex-col mt-2 space-y-4 md:flex md:space-y-0 md:flex-row md:items-center md:space-x-10 md:mt-0">
            ...
            <x-nav-link style="color: rgba(229, 231, 235);" class="text-sm font-medium text-gray-200 transition-colors duration-300 transform" :href="route('vehicles')" :active="request()->routeIs('vehicles')">Campers & Caravans</x-nav-link>
