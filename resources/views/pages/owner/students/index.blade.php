<x-app-layout>
                ...
                <div class="md:flex flex-row w-full justify-center lg:justify-start lg:w-10/12 xl:w-8/12 2xl:w-6/12">
                    ...
                    <div class="basis-3/9 md:mr-4">
                        <button onclick="openDialogForMultipleItems()"
                            ...
                            Leerling(en) verwijderen
                        </button>
                    </div>
                    <div class="basis-3/9">
                        <a href="{{ route('generatestudents') }}">
                            <button
                                class="w-full mb-4 py-6 px-8 lg:py-2 lg:px-4 bg-indigo-600 hover:bg-indigo-500 text-white rounded text-sm font-bold transition duration-200">
                                Naar PDF exporteren
                            </button>
                        ...
                        <td class="w-full lg:w-auto text-center p-0 border-t">
                            <div class="flex flex-row h-full">
                                ...
                                <div class="basis-4/6 md:basis-5/6 px-3 py-2">
                                    <input type="checkbox" class="w-6 h-6 delete-multiple-items" value="{{$student->id}}">
                                </div>
                            </div>
                        </td>
                        <td class="w-full lg:w-auto text-center p-0 border-t">
                                ...
                                <div class="basis-4/6 md:basis-5/6 px-3 py-2">
                                    <div class="flex justify-center">
                                        <div class="flex flex-row w-8/12 lg:w-full">
                                            <div class="basis-2/4">
                                                <div class="flex justify-center">
                                                    <a class="cursor-pointer" href="student/edit/{{$student->id}}">
                                            ...
                                            <div class="basis-2/4">
                                                <div class="flex justify-center">
                                                    <a class="cursor-pointer" onclick="openDialog({{$student->id}})">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
    ...
    <div id="modal" style="display:none;"
        ...
        <script>
            ...
            function deleteItem() {
                hideDialog();
                window.location.replace(`/student/delete/${itemIDs}`);
                itemIDs.length = 0;
            }
