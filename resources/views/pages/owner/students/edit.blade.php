    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 m-5">
        <div class="mt-10 sm:mt-0">
            <div class="mt-5 md:mt-0 md:col-span-2">
                ...
                <form enctype="multipart/form-data" action="{{ route('studentupdate')}}" type='submit' method="POST">
                    @csrf
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <input value="{{$user->first_name}}" placeholder="Voornaam" type="text" name="first_name"
                                           id="first_name"
                                           class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <input value="{{$user->prefix}}" placeholder="Tussenvoegsels" type="text" name="prefix"
                                           id="prefix"
                                           class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <input value="{{$user->last_name}}" placeholder="Achternaam" type="text" name="last_name"
                                           id="last_name"
                                           class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <input value="{{$user->student->address}}" placeholder="Adres" type="text" name="address"
                                           id="address"
                                           class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <input value="{{$user->student->city}}" placeholder="Plaats" type="text" name="city"
                                           id="city"
                                           class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    @if ($errors->has('city'))
                                        <div class="text-red-700 text-sm">
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <input value="{{$user->student->postal_code}}" placeholder="Postcode" type="text" name="postal_code"
                                           id="postal_code"
                                           class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <input value="{{$user->student->lessons_to_go}}" placeholder="Lessen tegoed" type="number" name="lessons_to_go"
                                           id="lessons_to_go"
                                           class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
...
{{--                                    <input value="{{$user->}}" placeholder="Wachtwoord" type="password" name="password"--}}
{{--                                           id="password"--}}
{{--                                           class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">--}}
