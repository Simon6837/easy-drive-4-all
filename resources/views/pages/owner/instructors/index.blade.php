        ...
        <div class="w-11/12 xl:w-10/12 shadow rounded-lg border-gray-200 mb-8 overflow-hidden">
            ...
            <table class="border-collapse w-full">
                ...
                <tr>
                    ...
                    <th class="p-3 font-bold uppercase bg-gray-200 text-gray-500 hidden lg:hidden 2xl:table-cell">Omschrijving</th>
                    ...
                    <tr class="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                        ...
                        <td class="w-full lg:w-auto text-center p-0 border-t">
                            <div class="flex flex-row h-full">
                                ...
                                <div class="basis-4/6 md:basis-5/6 px-3 py-2 flex justify-center">
                                    <div class="w-12 max-w-12 break-words">
                                        {{$instructor->id}}
                                    </div>
                                </div>
                            </div>
                        ...
                        <td class="w-full lg:w-auto text-center p-0 border-t">
                            <div class="flex flex-row h-full">
                                ...
                                <div class="basis-4/6 md:basis-5/6 px-3 py-2 max-w-full flex justify-center">
                                    <div class="w-48 max-w-48 md:w-96 md:max-w-96 lg:w-28 lg:max-w-28 xl:w-36 lg:max-w-36 break-words">
                        ...
                        <td class="w-full lg:w-auto text-center p-0 border-t">
                            <div class="flex flex-row h-full">
                                ...
                                <div class="basis-4/6 md:basis-5/6 px-3 py-2 max-w-full flex justify-center">
                                    <div class="w-24 max-w-24 break-words text-center">
